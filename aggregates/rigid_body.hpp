...
struct RigidBody
{
  ...
  static ForceApplied execute(const state_type& state, const ApplyForce& command)
  {
  ...
  static std::vector<Entity::Move> process(const state_type& state, const TimeAdvanced& event)
  {
