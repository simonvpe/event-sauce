...
void
save(Archive& ar, std::variant<Types...> const& v, unsigned int /*version*/
)
{
...
template<class Archive, class... Types>
void
load(Archive& ar, std::variant<Types...>& v, const unsigned int version)
{
  std::size_t which;
  ar >> BOOST_SERIALIZATION_NVP(which);
...
template<class Archive, class... Types>
inline void
serialize(Archive& ar, std::variant<Types...>& v, const unsigned int file_version)
{
