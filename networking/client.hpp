...
public:
  ...
  public:
        ...
        , broker{ zmq, ZMQ_DEALER }
    {
      ...
      event_loop_instance = std::async(std::launch::async, &context_type::event_loop, this, std::move(callback));
    }
  ...
  static std::unique_ptr<context_type> start(const std::string& endpoint, callback_type callback)
  {
